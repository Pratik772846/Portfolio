            ...
            <div className='flex flex-col p-4 pt-8 md:w-[40%] justify-center max-w-screen mx-auto h-full'>
              ...
              <div className='flex justify-center items-center'>
                  <form action='https://getform.io/f/a5328eb2-c3ef-4826-842f-911e5eec2c2d' method='POST' className='flex flex-col w-full'>
                      <input type="text" name = "name" placeholder = "Enter your name" className = "p-2 border-2 rounded-md focus:outline-none focus:outline-[#eb8034] text-orange-500 " required></input>
                      <input type="email" name = "email" placeholder = "Enter your email" className = " my-4 p-2 border-2 rounded-md focus:outline-[#eb8034] text-orange-500" required></input>
                      <textarea name='message' rows='10' placeholder='Enter your message' className='p-2  border-2 rounded-md focus:outline-[#eb8034] text-orange-500'></textarea>
